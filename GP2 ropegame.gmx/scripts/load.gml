//physics_pause_enable(true); //pauses physics in order to prevent shit hitting the fan
...
//physics_pause_enable(false); //this prevents everything working for some stupid reason...
